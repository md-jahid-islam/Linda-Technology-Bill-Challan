...
const SELLER_DATA = {
    ...
    email: "morzaharif.accessories@gmail.com, mali.apnooralamin@yahoo.com",
    docType: "M/S LT. BILL",
    themeColor: "red-600"
};
        ...
        <div className="p-4 sm:p-6 lg:p-8 bg-gray-50 min-h-screen font-sans">
            ...
            <div>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                ...
                <Link to={"/CreateChalalln1"}>M/S LT. Back To Chalalln</Link>
              </button>
              </div>    
            <div className="max-w-4xl mx-auto bg-white border border-gray-300 shadow-2xl rounded-xl overflow-hidden bill-container">
                ...
                <header className="p-4 sm:p-6 border-b border-gray-300">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-4">
                        <div className={`flex-shrink-0 flex items-center justify-center w-14 h-14 border-3 border-blue-700 rounded-full text-blue-700 font-extrabold text-2xl shadow-md`}>
                            {logoText}
                        </div>
                        <div className="flex-grow">
                            ...
                            <p className={`text-xs sm:text-sm text-blue-700 font-semibold mt-1`}>
                                Contact: {contact}
                            </p>
                ...
                {/* 🔵 Document Type Label */}
                <div className={`text-center py-3 bg-blue-700`}>
                ...
                <div className="p-4 sm:p-6 pt-0">
                    ...
                    <div className="overflow-x-auto rounded-lg shadow-lg border border-gray-300">
                        <table className="min-w-full border-collapse text-sm">
                            ...
                            <tfoot>
                                <tr className="bg-gray-200 font-extrabold border-t-2 border-blue-700">
                    ...
                    <div className="flex justify-between items-end text-xs mt-12 pt-4">
                        ...
                        <div className="w-[30%] text-center">
                            <input 
                                ...
                                onChange={handleBillInfoChange}
                                className="w-full text-center border-t-2 border-gray-800 pt-1 text-gray-800 focus:ring-0 focus:border-blue-500 outline-none placeholder-gray-400 font-medium bg-white print-signature-input"
