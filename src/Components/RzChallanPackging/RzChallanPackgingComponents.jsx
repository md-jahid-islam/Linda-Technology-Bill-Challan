...
const RzChallanPackgingComponents = () => {
    ...
    const InfoField = ({ label, name, value, onChange, placeholder = "", type = "text", className = " text-red-600 " }) => (
        <div className={`flex flex-col sm:flex-row items-start sm:items-center py-1 ${className}`}>
            ...
            <input
                ...
                className={`flex-grow py-1 px-2 border-b border-gray-400 focus:border-red-500 focus:ring-0 outline-none transition-colors duration-150 rounded-sm text-sm print-input`}
                required
            />
        </div>
    );
           ...
           <div>
            ...
            <div className="max-w-4xl mx-auto bg-white border border-gray-300 shadow-xl rounded-xl overflow-hidden pad-container">
                ...
                <div className="flex justify-end p-4 sm:p-6 pb-0 no-print">
                    <button
                        onClick={handlePrint}
                        className="flex items-center space-x-2 px-6 py-2 bg-green-600 text-white font-semibold rounded-lg shadow-md hover:bg-green-700 transition duration-200"
                    >
                ...
                <header className="p-6">
                    <div className="flex items-start justify-start space-x-4">
                        ...
                        <div className="flex-shrink-0 flex flex-col items-center justify-center pt-2">
                            <div className={`text-${logoColor} font-extrabold text-3xl leading-none`}>
                                {logoText}
                            </div>
                            <span className="text-xs text-gray-600 italic">Packaging</span>
                        </div>
                ...
                <div className="p-6 pt-2 space-y-2 text-sm">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <InfoField
                            label="Company Name:"
                            name="companyName"
                            value={challanInfo.companyName}
                            onChange={handleChallanInfoChange}
                            className="pr-4"
                        />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <InfoField
                            ...
                            name="contactPerson"
                            value={challanInfo.contactPerson}
                            onChange={handleChallanInfoChange}
                            className="pr-4"
                        />
                         <InfoField
                                    ...
                                    <tr key={item.id} className="h-10 border-b border-gray-300 hover:bg-red-50 transition duration-150">
                                        ...
                                        <td className="p-0 border-r border-gray-400">
                                            <input
                                                ...
                                                className="w-full h-full p-2 text-center border-none focus:ring-0 focus:outline-none bg-transparent print-input"
                                            />
                                        </td>
                                        ...
                                        <td className="p-0 border-r border-gray-400">
                                            <input
                                                type="text"
                                                value={item.quantityRoll}
                                                onChange={(e) => handleItemChange(item.id, 'quantityRoll', e.target.value)}
                                                placeholder="0"
                                        ...
                                        <td className="p-0 border-r border-gray-400">
                                            <input
                                                ...
                                                onChange={(e) => handleItemChange(item.id, 'quantityKG', e.target.value)}
                                                placeholder="0.00"
                                                className="w-full h-full p-2 text-right border-none focus:ring-0 focus:outline-none print-input"
                                            />
                                        </td>
                    ...
                    <div className="text-sm mb-12">
                        <div className="flex items-start">
                            ...
                            <input
                                ...
                                name="totalInWord"
                                type="text"
                                value={challanInfo.totalInWord}
                                onChange={handleChallanInfoChange}
                                placeholder="[Enter total quantity/value in words...]"
                    ...
                    <div className="flex justify-between items-end text-xs mt-12 pt-4">
                        ...
                        <div className="w-[30%] text-center">
                            <input 
                                type="text"
                                name="authorizedBy"
                                value={challanInfo.authorizedBy}
                                onChange={handleChallanInfoChange}
                                className="w-full text-center border-t-2 border-gray-800 pt-1 text-gray-800 focus:ring-0 focus:border-red-500 outline-none placeholder-gray-400 font-medium bg-white print-signature-input"
